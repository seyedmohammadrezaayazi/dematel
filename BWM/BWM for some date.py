...
best_to_criteria_list = [
 [5, 4, 6, 5, 4, 3, 7, 7, 3, 8, 5, 1, 4, 5, 5, 3, 4, 5, 4, 9, 3, 5], # خبره 1
 [4, 3, 1, 6, 2, 7, 8, 8, 4, 8, 2, 3, 8, 6, 8, 3, 4, 5, 5, 9, 7, 6], # خبره 2
 [2, 1, 3, 2, 2, 3, 7, 8, 3, 7, 4, 4, 4, 5, 7, 5, 3, 4, 5, 9, 5, 4],
 [2, 2, 3, 3, 1, 4, 6, 7, 2, 8, 4, 4, 3, 4, 6, 4, 5, 4, 5, 9, 5, 3],
 [3, 2, 2, 3, 1, 4, 5, 6, 4, 7, 3, 4, 3, 4, 6, 4, 3, 4, 5, 9, 5, 3]
]

criteria_to_worst_list = [
 [7, 6, 6, 6, 6, 5, 4, 4, 7, 2, 6, 9, 6, 6, 6, 6, 6, 7, 5, 1, 6, 6], # خبره 1
 [7, 6, 9, 6, 9, 2, 2, 3, 7, 3, 7, 7, 5, 4, 4, 6, 5, 5, 4, 1, 4, 3], # خبره 2
 [8, 9, 7, 8, 9, 7, 3, 3, 8, 2, 6, 6, 7, 5, 4, 6, 8, 7, 6, 1, 6, 7],
 [8, 8, 7, 7, 9, 6, 4, 3, 8, 3, 6, 6, 7, 4, 4, 6, 5, 6, 5, 1, 5, 7],
 [7, 8, 8, 7, 9, 6, 5, 4, 7, 2, 7, 6, 7, 4, 4, 6, 7, 8, 6, 1, 5, 8]
]
